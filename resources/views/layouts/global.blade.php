...
<head>
    ...
    <title>Manajemen Paket - @yield("title")</title>
...
<nav class="navbar navbar-expand p-0">
    <a class="navbar-brand text-center col-xs-12 col-md-3 col-lg-2 mr-0"
       href="{{route('home')}}"> Manajemen Paket </a>
...
4" type="text" placeholder="Search" aria-label="Search" />
                ...
                <li><a href="/laravel_google_chart">
                        <span class="oi oi-dashboard"></span> dashboard</a>
                </li>
                <li><a href="{{route('barang.index')}}">
                        <span class="oi oi-spreadsheet"></span> Manage Packet</a>
                </li>
                <li>
                    <form action="{{route("logout")}}" method="POST">
                        @csrf
